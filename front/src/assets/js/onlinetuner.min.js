...
(function() {
  ...
  var h = function(a) {
    ...
    for (var i = 0; i < b.length; i++) {
      b[i] =
        0.42 -
        0.5 * Math.cos((2 * Math.PI * i) / (b.length - 1)) +
        0.08 * Math.cos((4 * Math.PI * i) / (b.length - 1));
    }
    return b;
  };
  var j = function(a) {
  ...
  var n = function(c, d, e) {
    ...
    this.fft = new OnlineTuner.FFT(
      this.precision,
      this.audioContext.sampleRate
    );
    this.scriptNode = this.audioContext.createScriptProcessor(
      Math.min(this.precision, 16384),
      1,
      1
    );
    var f = this;
...
(function() {
  ...
  var h = function(a) {
    ...
    return { string: c + 1, note: g[c], delta: d };
  };
  var i = function() {};
  i.prototype = { notify: OnlineTuner.virtual };
  var j = function(a) {
    i.call(this);
    this.widget = a;
  };
  j.prototype = {
    notify: function(a) {
      ...
      this.widget.show(
        ...
        b.note,
        "string " + b.string,
        a.note + "" + a.octave + "(" + Math.round(a.frequency) + "Hz)"
      );
    }
  };
  OnlineTuner.Controller = { GuitareTuner: j };
})();
(function() {
      ...
      while (d < c) {
        ...
        for (var g = 0; g < d; g++) {
          ...
          while (i < c) {
            off = i + d;
            tr =
              currentPhaseShiftReal * a[off] - currentPhaseShiftImag * b[off];
            ti =
              currentPhaseShiftReal * b[off] + currentPhaseShiftImag * a[off];
            a[off] = a[i] - tr;
            b[off] = b[i] - ti;
            a[i] += tr;
            b[i] += ti;
...
(function() {
  ...
  OnlineTuner.Widget = { CircleWidget: f };
})();
